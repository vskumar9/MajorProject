...
import {signupGoogle, signup , signinGoogle, login} from '../../actions/auth'
            ...
            <div class='auth-container-2'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    </label>
                    {
                        isSignup && (
                            <label htmlFor='check'>
                                <input type="checkbox" id='check' style={{ width:"13px", margin:"-30px 7px 0px 0px" }}/>
                ...
                <p>
                {isSignup ? <button type='button' className='handle-switch-btn' onClick={() => SignUp()} >SignUp Google</button> : <button type='button' onClick={() => Login()} >Login Google</button>}
                </p>
            </div>
        </section>
    )

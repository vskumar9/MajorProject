...
const EditProfileForm = ({ currentUser, setSwitch }) => {
    ...
    //     setavatar(e.target.files[0]) // Update image state with selected file
        ...
        <div>
            ...
            <form className="edit-profile-form" onSubmit={handleSubmit}>
                ...
                {/* <label htmlFor="image">
                    ...
                    <input type="file" name="image" id="image" onChange={handleImageChange} accept=".jpg,.jpeg,.png,.gif"/>
                </label> */}
                <label htmlFor="about">
                    <h3>About me</h3>

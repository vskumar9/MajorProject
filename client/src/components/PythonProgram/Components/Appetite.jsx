...
import './css/appetite.css'

const Appetite = () => {
  return (
    <div className='p-body'>
<section id="whetting-your-appetite">
<span id="tut-intro"></span><h1><span class="section-number">1. </span>Whetting Your Appetite<a class="headerlink" href="#whetting-your-appetite" title="Permalink to this headline">¶</a></h1>
